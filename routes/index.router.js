...
router.get("/getLists", ctrlList.getLists);
...
router.post(
  "/createItemList/:id/:list_id",
  jwtHelper.verifyJwtToken,
  ctrlList.createItemByList
);
router.get(
  "/getItemByList/:list_id",
  jwtHelper.verifyJwtToken,
  ctrlList.getItemsByList
);
router.put(
  "/updateItemByList/:id",
  jwtHelper.verifyJwtToken,
  ctrlList.updateItemByList
);
router.delete(
  "/deleteItemByList/:id/:list_id",
  jwtHelper.verifyJwtToken,
  ctrlList.deleteItemByList
);

router.post(
  "/createItem/:user_id/:category_id/:list_id",
  jwtHelper.verifyJwtToken,
  ctrlItem.createItem
);
...
router.post(
  "/createCategory/:id",
  jwtHelper.verifyJwtToken,
  ctrlCategory.createCategory
);
router.get("/getCategory", jwtHelper.verifyJwtToken, ctrlCategory.getCategory);
router.put(
  "/updateCategory/:id",
  jwtHelper.verifyJwtToken,
  ctrlCategory.updateCategory
);
router.delete(
  "/deleteCategory/:id",
  jwtHelper.verifyJwtToken,
  ctrlCategory.deleteCategory
);
